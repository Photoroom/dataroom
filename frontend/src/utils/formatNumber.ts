...
export function formatNumber(number: number | string | undefined | null, { thousandsSeparator = ',', decimals = 2 }: FormatNumberOptions = {}): string {
  ...
  let formattedNumber = decimals > 0 && decimalPart 
