...
export function SidebarProvider({ initialActiveNav, children }: { initialActiveNav: SidebarActiveNav, children: React.ReactNode }) {
  ...
  return (  
    <SidebarContext.Provider value={{ isSidebarOpen, toggleSidebar, isSidebarNavOpen, setIsSidebarNavOpen, sidebarActiveNav, setSidebarActiveNav }}>
      {children}
